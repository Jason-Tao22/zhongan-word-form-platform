...
| `openai_analyzer.py` | 调用 OpenAI API，分批处理表格，返回 subForms list |
...
| `requirements.txt` | 依赖：fastapi, uvicorn, python-docx, lxml, openai, pydantic |
...
| AI 分析（分批调用 OpenAI） | ✅ 返回 14 个 subForm |
